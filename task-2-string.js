...
let firstChar = string.charAt(0); //получаем букву по ее индексу
let lastChar = string.charAt(15);
...
let result = string.match("string"); //метод ищет совпадения в строке
...
let fromTo = string.substr(5, [4]); //извлекает from>leight
console.log(fromTo); //test


// **************Получить строку с 5-го по 9-й символы****************
let fromTo2 = string.slice(4, 10); //возвращает новую между двумя индексами
...
let a = 20;
let b = 16;
let c = (a + "") + (b + ""); // преобразовываем к строке добавляя пустую строку
console.log(c); //2016