...
const name = "'Домкрат гидравлический'";
let price = '100';
...
} // ordered = 20 ordered = 80 Заказ оформлен, с вами свяжется менеджер
// ordered = 130 На складе недостаточно твоаров! 
...
let howMany = prompt('количество дроидов которые пользователь хочет купить?')
let totalprice = howMany * pricePerDroid;

if (howMany === null) {
    alert('Отменено пользователем!')
} else if (howMany > 0, totalprice > credits) {
    alert('Недостаточно средств на счету!')
} else {
    let result = credits - totalprice;
    alert(`Вы купили ${howMany} дроидов, на счету осталось ${result} кредитов.`)
}
...
// Индия - 80 кредитов
// Ямайка - 120 кредитов
let country = prompt("В какую страну доставить посылку?", "").toLowerCase();
switch (country) {
    case "китай":
